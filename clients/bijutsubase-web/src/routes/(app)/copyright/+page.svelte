<script lang="ts">
	...
	let loadPage = $derived((skip: number, limit: number): Promise<TagBrowseItem[]> => {
		return getTagsByCategory('copyright', skip, limit, settings.maxRating ?? undefined);
	});
...
<div class="flex flex-1 flex-col overflow-hidden">
	<div
		class="flex shrink-0 items-center justify-between border-b border-gray-200 bg-white p-4 dark:border-gray-700 dark:bg-zinc-900"
	>

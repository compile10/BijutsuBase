...
- `POST /api/upload/url` — Upload image/video from URL; downloads to temp file; validates type; computes hashes; extracts dimensions; persists; auto-enriches from Danbooru and ONNX model.

...
def preprocess_image(image_path: Union[str, Path], target_size: int = 448) -> np.ndarray:
    """
    Load an image and preprocess it for the ONNX tagger model.
    
    Steps:
    - Load image from disk using OpenCV (loads as BGR)
